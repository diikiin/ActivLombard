...
public class PiedgeAdapter extends FirebaseRecyclerAdapter<PiedgeTicket, PiedgeAdapter.piedgeViewholder>{

    public PiedgeAdapter(@NonNull FirebaseRecyclerOptions<PiedgeTicket> options) {
        super(options);
    }

    @Override
    protected void
    onBindViewHolder(@NonNull piedgeViewholder holder, int position, @NonNull PiedgeTicket model) {
...
//            holder.id.setText(String.valueOf(model.getId()));
    ...
    class piedgeViewholder extends RecyclerView.ViewHolder {
